...
it has a **4 key layout with a custom shell, working on the Seeed Studio RP2040** **, a rotary encoder with a switch, leds (**flashin**) and an oled with a bongo cat!!!** _meow_  
all keys can be modified with **VIA** (Google AI told me about it and it seems cool!!)
## hardest part for me? x_x
